...
//This file is for saving an new buyer
	...
	$result1=mysqli_query($con,"INSERT INTO tbl_yagan_feeding(feedingid,feedtype,animal,feeddate,feedqnty,feedingtime,feedingcomments) 
	VALUES ('$feedingid','$feedtype','$animalID','$feeddate','$feedqnty','$feedingtime','$feedingcomments')");
